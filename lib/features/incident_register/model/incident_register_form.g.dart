...
_$IncidentRegisterFormImpl _$$IncidentRegisterFormImplFromJson(
    ...
    _$IncidentRegisterFormImpl(
      ...
      incidentInvestigator: json['incident_investigator__rsm_name_'] as String?,
      ...
      complaint: json['fir__complaint'] as String?,
      remarks: json['remarks'] as String?,
      notifyEmployeeEmail: json['notify_employee_email'] as String?,
      ...
      amountCompensation:
          (json['amount_of_compensation_paid_by_ael'] as num?)?.toInt(),
      desc3: json['action_takenrecommendation'] as String?,
      photo: json['photographs_of_incident'] as String?,
...
Map<String, dynamic> _$$IncidentRegisterFormImplToJson(
    ...
    <String, dynamic>{
      ...
      'incident_investigator__rsm_name_': instance.incidentInvestigator,
      ...
      'fir__complaint': instance.complaint,
      'remarks': instance.remarks,
      'notify_employee_email': instance.notifyEmployeeEmail,
      ...
      'amount_of_compensation_paid_by_ael': instance.amountCompensation,
      'action_takenrecommendation': instance.desc3,
      'photographs_of_incident': instance.photo,
    };
