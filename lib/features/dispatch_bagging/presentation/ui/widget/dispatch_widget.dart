...
class DispatchWidget extends StatelessWidget {
  ...
  final DispatchBaggingModel dispatch;
            ...
            children: [
              Row(
                ...
                children: [
                  ...
                  Text(DFU.ddMMyyyyFromStr(dispatch.postingDate!),
                      style: AppTextStyles.titleLarge(context)
                          .copyWith(color: AppColors.black)),
                ],
              ),
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                Text('Customer : ${dispatch.customerName ?? ''}', style: AppTextStyles.titleMediumBlack(context)
              ...
              Row(
                ...
                children: [
                  ...
                  DocStatusWidget(
                      status: StringUtils.docStatus(dispatch.docstatus!))
                ],
              ),
            ],
          )),
