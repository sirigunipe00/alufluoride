...
DispatchBaggingModel _$DispatchBaggingModelFromJson(Map<String, dynamic> json) {
  return _DispatchBaggingModel.fromJson(json);
}

/// @nodoc
mixin _$DispatchBaggingModel {
  ...
  @JsonKey(ignore: true)
  $DispatchBaggingModelCopyWith<DispatchBaggingModel> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $DispatchBaggingModelCopyWith<$Res> {
  factory $DispatchBaggingModelCopyWith(DispatchBaggingModel value,
          $Res Function(DispatchBaggingModel) then) =
      _$DispatchBaggingModelCopyWithImpl<$Res, DispatchBaggingModel>;
  @useResult
  $Res call(
      {String? status,
...
/// @nodoc
class _$DispatchBaggingModelCopyWithImpl<$Res,
        $Val extends DispatchBaggingModel>
    implements $DispatchBaggingModelCopyWith<$Res> {
  _$DispatchBaggingModelCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$DispatchBaggingModelImplCopyWith<$Res>
    implements $DispatchBaggingModelCopyWith<$Res> {
  factory _$$DispatchBaggingModelImplCopyWith(_$DispatchBaggingModelImpl value,
          $Res Function(_$DispatchBaggingModelImpl) then) =
      __$$DispatchBaggingModelImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {String? status,
...
/// @nodoc
class __$$DispatchBaggingModelImplCopyWithImpl<$Res>
    extends _$DispatchBaggingModelCopyWithImpl<$Res, _$DispatchBaggingModelImpl>
    implements _$$DispatchBaggingModelImplCopyWith<$Res> {
  __$$DispatchBaggingModelImplCopyWithImpl(_$DispatchBaggingModelImpl _value,
      $Res Function(_$DispatchBaggingModelImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$DispatchBaggingModelImpl(
      status: freezed == status
          ? _value.status
          : status // ignore: cast_nullable_to_non_nullable
              as String?,
...
/// @nodoc
@JsonSerializable()
class _$DispatchBaggingModelImpl implements _DispatchBaggingModel {
  const _$DispatchBaggingModelImpl(
      {this.status,
  ...
  factory _$DispatchBaggingModelImpl.fromJson(Map<String, dynamic> json) =>
      _$$DispatchBaggingModelImplFromJson(json);
  ...
  @override
  String toString() {
    return 'DispatchBaggingModel(status: $status, name: $name, owner: $owner, creation: $creation, modified: $modified, modifiedBy: $modifiedBy, docstatus: $docstatus, idx: $idx, company: $company, shift: $shift, postingDate: $postingDate, batch: $batch, amendedFrom: $amendedFrom, uom: $uom, fgItem: $fgItem, qualityInspection: $qualityInspection, totalQty: $totalQty, isConsumptionCreated: $isConsumptionCreated, isFgCreated: $isFgCreated, productionEntry: $productionEntry, customerName: $customerName)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$DispatchBaggingModelImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$DispatchBaggingModelImplCopyWith<_$DispatchBaggingModelImpl>
      get copyWith =>
          __$$DispatchBaggingModelImplCopyWithImpl<_$DispatchBaggingModelImpl>(
              this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$DispatchBaggingModelImplToJson(
      this,
    );
  }
}

abstract class _DispatchBaggingModel implements DispatchBaggingModel {
  const factory _DispatchBaggingModel(
      {final String? status,
      ...
      @JsonKey(name: 'production_entry') final String? productionEntry,
      @JsonKey(name: 'customer_name')
      final String? customerName}) = _$DispatchBaggingModelImpl;

  factory _DispatchBaggingModel.fromJson(Map<String, dynamic> json) =
      _$DispatchBaggingModelImpl.fromJson;
